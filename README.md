...
- `GRACE_PERIOD_DURATION` - duration of the grace period in blocks. At the moment, the duration of the grace period in decimal-go-node is 15840 blocks (~ 24 hours). It is recommended to leave the value for the guard the same as for the node - 15840.
